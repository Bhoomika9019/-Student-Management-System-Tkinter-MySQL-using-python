...
def update_data():
    ...
    nameEntry.get(), mobileEntry.get(), emailEntry.get(), addressEntry.get(), genderEntry.get(), dobEntry.get(), date,
...
root.title('Student Management System') #s[count]=t when count is 1
